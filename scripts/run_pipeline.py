...
def main():
    ...
    # Input Args
    parser.add_argument("--data-key", type=str, default="hcmc-traffic-data.json", help="Input Raw JSON key")
    parser.add_argument("--graph-key", type=str, default="hcmc-clustered-graph.json", help="Input Graph Topology key")
